...
#version 2
def insert_course2(semester,course_prefix,course_number,course_section, course_hours):

    course=ElementTree.SubElement(semester, 'course')
    
    prefix=ElementTree.SubElement(course, 'prefix')
    prefix.text=course_prefix
